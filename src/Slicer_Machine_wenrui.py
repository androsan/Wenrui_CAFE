...
def Load_salome(naslov, x):
    fem = np.load(naslov+'/fem_'+str(x)+'.npy')
    return fem
...
PATH = appSettings["workDirectory"]+"/WORK/"    # APPLICATION WORK DIRECTORY
mapa = "INTER  time=1, space=8  Z[0-1], X[14-27], Y[209-224], 327degC, N=2" #appSettings["slicer machine"]["inter folder"]
'''============================================================================================================='''
...
Tmelt =                          327            # Melting Point (in Celsius)
dTliq =                              50            
